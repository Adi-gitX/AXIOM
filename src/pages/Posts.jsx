    ...
    return (
        ...
        >
            <div className="p-5 pb-0">
                ...
                <h2 className="text-xl font-bold text-gray-900 leading-tight mb-3 hover:text-blue-600 transition-colors">{post.title}</h2>
            ...
            <div className="mx-5 mb-4 h-1 bg-blue-500 rounded-full" />

            <div className="px-5 pb-5 flex items-center justify-between">
                <div className="flex items-center gap-1">
                    <button onClick={handleUpvote} className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all ${hasUpvoted ? 'text-blue-600 bg-blue-50' : 'text-gray-500 hover:bg-gray-100'}`}>
                    ...
                    <button onClick={handleDownvote} className={`p-2 rounded-xl transition-all ${hasDownvoted ? 'text-red-500 bg-red-50' : 'text-gray-400 hover:bg-gray-100'}`}>
                ...
                <div className="flex items-center gap-1">
                    <button onClick={(e) => { e.stopPropagation(); setIsSaved(!isSaved); }} className={`p-2.5 rounded-xl transition-all ${isSaved ? 'text-blue-600 bg-blue-50' : 'text-gray-400 hover:bg-gray-100'}`}>
            ...
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 40, scale: 0.95 }} className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden my-8 mx-4 flex" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex-1 max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                ...
                                <span className="text-xs text-emerald-600 font-medium">⚡ {post.author.reputation}</span>
                            </div>
                        </div>
                    ...
                    <div className="px-6 pb-4 flex flex-wrap gap-2">
                        <button className="px-4 py-2 bg-violet-100 text-violet-700 text-sm font-bold rounded-xl">✨ TLDR</button>
                    ...
                    <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                        <div className="flex items-center gap-1">
                            <button onClick={handleUpvote} className={`p-3 rounded-xl ${hasUpvoted ? 'bg-violet-100 text-violet-600' : 'hover:bg-gray-100 text-gray-500'}`}>
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M18 15l-6-6-6 6" strokeLinecap="round" strokeLinejoin="round" /></svg>
                            </button>
                            <button onClick={handleDownvote} className={`p-3 rounded-xl ${hasDownvoted ? 'bg-red-100 text-red-500' : 'hover:bg-gray-100 text-gray-500'}`}>
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M6 9l6 6 6-6" strokeLinecap="round" strokeLinejoin="round" /></svg>
                            </button>
                        </div>
                        <div className="flex items-center gap-1">
                            ...
                            <button onClick={() => setIsSaved(!isSaved)} className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm ${isSaved ? 'bg-amber-100 text-amber-600' : 'hover:bg-gray-100 text-gray-600'}`}>
                ...
                <div className="w-80 bg-gray-50 border-l border-gray-100 p-6 hidden lg:block max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="bg-white rounded-2xl p-5 mb-5 border border-gray-100">
                        ...
                        <button onClick={() => setIsFollowing(!isFollowing)} className={`w-full py-2.5 font-semibold rounded-xl ${isFollowing ? 'bg-gray-100 text-gray-700' : 'bg-violet-600 text-white'}`}>
                            {isFollowing ? '✓ Following' : 'Follow'}
                        </button>
                        <p className="text-xs text-emerald-600 font-medium mt-4">⚡ {post.author.reputation}</p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-5 border border-gray-100">
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            <button onClick={handleCopyLink} className={`flex items-center justify-center p-3 rounded-xl ${copiedLink ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}>
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" /></svg>
                            </button>
