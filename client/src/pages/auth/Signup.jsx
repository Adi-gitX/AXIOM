...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // In a real app, you might want to create the user in your Postgres DB here too
            navigate('/app');
        } catch (err) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-primary/20 rounded-full blur-[120px] animate-pulse" />
            ...
            <div className="w-full max-w-md p-8 rounded-[2rem] bg-background/50 backdrop-blur-3xl border border-white/20 dark:border-white/5 shadow-2xl relative z-10">
                ...
                <div className="mt-8 text-center">
                    <p className="text-muted-foreground">
                        ...
                        <Link to="/login" className="text-foreground font-bold hover:underline decoration-2 underline-offset-4">
                            Log In
                        </Link>
                    </p>
                </div>
